> Reference copy of pi's `docs/extensions.md` (MIT, https://github.com/earendil-works/pi). pirs implements a subset: read [extensions.md](extensions.md) first for what works in pirs; use this file for detailed event payload fields and examples.
